...
if __name__ == '__main__':
    ...
    X_train, X_val, Y_train, Y_val = train_test_split(train, train_target, \
                        test_size=conf.test_size, random_state=conf.random_state)

    print 'transform feature ...'


    dt = RandomForestClassifier(min_samples_leaf=30, max_depth=2, n_estimators=1000,\
                                max_features=2,  random_state=conf.random_state)
